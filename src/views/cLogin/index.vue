  ...
  <el-container class="login-container">
    ...
    <el-card class="animated flipInY">
      ...
      <el-form :rules="rules" :model="loginForm" ref="loginForm" label-width="60px">
        ...
        <el-form-item label="Remember" label-width="80px">
          <el-switch v-model="remember"></el-switch>
        </el-form-item>
        <el-button type="primary" @click="onLogin('loginForm')" :loading="loading">Login</el-button>
      </el-form>
    </el-card>
    ...
    return {
      ...
      rules: {
        username: [
          ...
          { min: 6, max: 10, message: "长度在6到10个字符", trigger: "change" }
        ],
        password: [
